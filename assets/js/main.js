...
document.getElementById('contactForm').addEventListener('submit', function (event) {
      ...
      const bodyContent = `Hi Satyam,\n\nI am ${nameInputValue}. I hope this email finds you.\n\n${messageInputValue}`;

      const mailtoLink = `mailto:satyamjsw12@gmail.com?subject=${encodeURIComponent('Reg: ' + subjectInputValue)}&body=${encodeURIComponent(bodyContent)}`;
